...
class BinarySearchTree {
  ...
  rangeNoStart(startNode = this.root.right) {
    if (startNode == null) {
      return null;
    }
    let tempList = new BinarySearchTree();
    tempList.root = startNode;
...
// console.log(threeLevelTree.contains(0));
// console.log(emptyTree.contains(0));
// console.log(threeLevelTree.contains(5));
// console.log(threeLevelTree.contains(13));
// console.log(twoLevelTree.contains(0));
// console.log(twoLevelTree.contains(5));

// console.log(threeLevelTree.containsRecursive(0));
// console.log(emptyTree.containsRecursive(0));
// console.log(threeLevelTree.containsRecursive(5));
// console.log(threeLevelTree.containsRecursive(13));
// console.log(twoLevelTree.containsRecursive(0));
// console.log(twoLevelTree.containsRecursive(5));

// console.log(threeLevelTree.rangeNoStart());

// console.log(twoLevelTree.rangeNoStart());
